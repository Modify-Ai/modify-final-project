          ...
          <Routes>
            ...
            <Route element={<Layout />}>
              ...
              <Route element={<AdminRoute />}> 
                ...
                <Route path="/admin/upload" element={<ProductUpload />} /> {/* 상품 등록 (AI/CSV) */}
                <Route path="/admin/products" element={<ProductManagement />} /> {/* 상품 관리 */}
                <Route path="/admin/customers" element={<CustomerManagement />} /> {/* 고객 관리 */}
                <Route path="/admin/sales" element={<SalesManagement />} />      {/* 판매 관리 */}
              </Route>
            </Route>
